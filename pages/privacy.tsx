...
const Cookies: NextPage = () => {
  ...
  return (
    <Layout title={TITLE} canonical={CANONICAL} image="" type={TYPE} description={DESCRIPTION}>
      <Post>
        <h1>{TITLE}</h1>
        <h2>Quick Human Readable Summary</h2>
        <ul>
          <li>
            We store personal information in the form of your email for account logins, password
            resets, and opt-in-only notification/price-drop emails.
          </li>
          <li>
            We store personal information in the form of your IP addresses for legitimate interests,
            specifically: security, spam prevention, and fraud detection.
          </li>
          <li>
            We do not share your personal information with anyone except to comply with the law or
            protect our rights.
          </li>
          <li>
            We have not sold your personal information. We will not sell your personal information.
            You are automatically opted-out from Setupps selling your personal information now or in
            the future.
          </li>
          <li>
            We request your consent when required by law to store or process personally identifying
            information that is not essential to the operation of our website.
          </li>
        </ul>
        <h2>Introduction</h2>
        <p>
        ...
        <p>
          This policy applies where we are acting as a data controller with respect to the personal
        ...
        <p>
          ...
          provision of our website and services, we will ask you to consent to our use of cookies
          when you first visit our website.
        </p>
        <p>
          Our website incorporates opt-in email controls which affect how we will process your
          personal data. By using the controls, you can specify whether you would like to receive
          direct email communications such as comment reply notifications or price drop
          notifications.
        </p>
        <p>In this policy, "we", "us" and "our" refer to Setupps.</p>
        ...
        <p>
          ...
          data may include your IP address, geographical location, browser type and version,
          operating system, referral source, length of visit, page views and website navigation
          paths, as well as information about the timing, frequency and pattern of your service use.
          The source of the usage data is our analytics tracking system. This usage data may be
          ...
          website and services, security, and fraud prevention.
        </p>
        <p>
          We may process your account data ("account data"). The account data may include your email
          address. The source of your account data is you. The account data may be processed for the
          purposes of operating our website, providing our services, ensuring the security of our
        ...
        <p>
          ...
          data"). The profile data may include your email address, profile pictures. The profile
        ...
        <p>
          ...
          services ("service data"). The service data may include your IP address. The source of the
          service data is you. The service data may be processed for the purposes of operating our
          ...
          processing is our legitimate interests, namely the proper administration of our website
        ...
        <p>
          We may process information relating to transactions, including clickthroughs to retailers
          or partners through our website ("transaction data"). The transaction data may be
          processed for the purpose of aggregating usage statistics, security, and fraud prevention.
          The legal basis for this processing is the proper administration of our website and
          business.
        </p>
        <p>
          ...
          processed for the purposes of sending you the relevant notifications. The legal basis for
          this processing is consent.
        </p>
        <p>
          We may process information contained in or relating to any communication that you send to
        ...
        <p>
          ...
          in this section, we may also process any of your personal data where such processing is
        ...
        <p>
          ...
          to security, spam prevention, and fraud detection.
        </p>
        <p>
          This automated decision-making will involve usage pattern analysis to detect malicious
          behavior, spam, or violations of our Terms of Service or User Code of Conduct.
        </p>
        <p>
          The significance and possible consequences of this automated decision-making are warning
          notifications, the banning of your account, or the banning of your usage our website.
        </p>
        ...
        <p>
          ...
          a legal obligation to which we are subject, or in order to protect your vital interests or
        ...
        <p>
          In this section, we provide information about the circumstances in which your personal
          data may be transferred to countries outside the European Economic Area (EEA).
        </p>
        <p>
          We have offices and facilities in the United States. Transfers will be protected by
          ...
          <a href="https://www.eugdpr.org/">here</a>.
        </p>
        <p>
          The hosting facilities for our website are situated in the United States. Transfers will
          be protected by appropriate safeguards, namely the use of standard data protection clauses
        ...
        <p>
          We may retain your email addresses for a maximum period of 30 days following the deletion
          of the account.
        </p>
        <p>
        ...
        <ul>
          <li>
            the period of retention of ip addresses will be determined based on the requirements of
            website security, spam prevention, and fraud prevention.
          </li>
        </ul>
        <p></p>
        <p>
        ...
        <p>
          We will take appropriate technical and organisational precautions to secure your personal
          data and to prevent the loss, misuse or alteration of your personal data.
        </p>
        <p>We will store all your personal data on secure servers.</p>
        <p>The following personal data will be stored by us in encrypted form: password(s).</p>
        <p>
          Data relating to your enquiries and transactions that is sent from your web browser to our
          web server, or from our web server to your web browser, will be protected using encryption
          technology.
        </p>
        <p>
          You acknowledge that the transmission of unencrypted (or inadequately encrypted) data over
          the internet is inherently insecure, and we cannot guarantee the security of data sent
          over the internet.
        </p>
        <p>
          ...
          you log in to our website, change your password, or change your email address).
        </p>
        <h2>Amendments</h2>
        <p>
        ...
        <p>
          We may notify you of significant changes to this policy by email or through announcements
          on our website.
        </p>
        <h2>Your Rights</h2>
        <p>
        ...
        <ul>
          <li>the right to know what personal informaton is being collected about you;</li>
          <li>
          ...
          <li>the right to withdraw consent; and</li>
        ...
        <p>
          ...
          categories of personal data concerned and the recipients of the personal data. Providing
          the rights and freedoms of others are not affected, we will supply to you a copy of your
          personal data. The first copy will be provided free of charge, but additional copies may
        ...
        <p>
          ...
          right to erasure. The general exclusions include where processing is necessary: for
        ...
        <p>
          ...
          our processing, but you require personal data for the establishment, exercise or defence
          of legal claims; and you have objected to processing, pending the verification of that
          objection. Where processing has been restricted on this basis, we may continue to store
          your personal data. However, we will only otherwise process it: with your consent; for the
        ...
        <p>
          ...
          an objection, we will cease to process the personal information unless we can demonstrate
        ...
        <p>Our website and services are targeted at persons at least the age of 13.</p>
        <p>
